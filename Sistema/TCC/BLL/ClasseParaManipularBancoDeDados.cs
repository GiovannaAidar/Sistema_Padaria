...
namespace BLL
{
    public class ClasseParaManipularBancoDeDados
    {
        ...
        public static string stringConexao = "server = localhost; database=Projeto; user id = sa; password=123456"; // @"server=P3L2M16; database=Projeto; user id = sa; password=123456";
        ...
        public string strConn = @"server = localhost; database = GreenHouse; user = sa; password = 123456; MultipleActiveResultSets=True";
