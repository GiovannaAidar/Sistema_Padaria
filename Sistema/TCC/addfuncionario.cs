...
namespace TCC
{
    public partial class addfuncionario : Form
    {
        ...
        public MaskedTextBox CPF { get; private set; }
        ...
        private void btnSalvar_Click(object sender, EventArgs e)
        {
            ...
            strSql = "insert into funcionario(Nome,Telefone,Celular,Email,Sexo,Cargo,DataNascimento,CEP,Logradouro,Cidade,UF,Bairro,Numero,RG,CPF,Complemento,StatusFunc) values(@Nome,@Telefone,@Celular,@Email,@Sexo,@Cargo,@DataNascimento,@CEP,@Logradouro,@Cidade,@UF,@Bairro,@Numero,@RG,@CPF,@Complemento,'ativo')";
            ...
            comando.Parameters.Add("@Cargo", SqlDbType.VarChar).Value = cboCargo.Text;
            ...
            comando.Parameters.Add("@StatusFunc", SqlDbType.VarChar).Value = cboStatus.Text;
            ...
            try
            {
                ...
                {
                    MessageBox.Show("PREENCHA O CAMPO EMAIL", "ATENÇÃO!", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }

                else if (cboSexo.Text == string.Empty)
                {
                    MessageBox.Show("PREENCHA O CAMPO SEXO", "ATENÇÃO!", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }

                else if (cboCargo.Text == string.Empty)
                {
                    MessageBox.Show("PREENCHA O CAMPO CARGO", "ATENÇÃO!", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }

                else if (mskNascimento.Text == string.Empty)
                {
                    MessageBox.Show("PREENCHA O CAMPO DATA DE NASCIMENTO", "ATENÇÃO!", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }

                else if (cboStatus.Text == string.Empty)
                {
                    MessageBox.Show("PREENCHA O CAMPO STATUS", "ATENÇÃO!", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }

                else if (mskRG.Text == string.Empty)
                {
                    MessageBox.Show("PREENCHA O CAMPO RG", "ATENÇÃO!", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
                ...
                else
                {
                    ...
                    if (cboCargo.Text == "GERENTE" || cboCargo.Text == "ATENDENTE")
                    {
                        MessageBox.Show("PARA ACESSAR O SISTEMA USE: " + "\n" + txtEmail.Text + "\n" + "\n" + "E SENHA:" + "\n" + "123456", "ATENÇÃO!", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
            ...
            catch (Exception ex)
            {
               ...
               // TODO - ALTERAR MENSAGEM DE ERRO
                ...
                {
                    MessageBox.Show("ESSE FUNCIONÁRIO JÁ ESTÁ CADASTRADO!", "ATENÇÃO!", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cboCargo.Text = Convert.ToString(dr["Cargo"]);
                mskNascimento.Text = Convert.ToString(dr["DataNascimento"]);
                cboStatus.Text = Convert.ToString(dr["StatusFunc"]);
        ...
        private void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            strSql = "update funcionario set Nome=@Nome, Telefone=@Telefone, Celular=@Celular, Email=@Email, Sexo=@Sexo, Cargo=@Cargo, DataNascimento=@DataNascimento, CEP=@CEP, Logradouro=@Logradouro, Cidade=@Cidade, UF=@UF, Bairro=@Bairro, Numero=@Numero, RG=@RG,Complemento=@Complemento, StatusFunc=@StatusFunc where CPF=@CPF " 
                + "update logins set usuario = @Nome, email = @Email, StatusFunc = @StatusFunc, CPF=@CPF  where CPF=@CPF";
            sqlCon = new SqlConnection(strCon);
            ...
            comando.Parameters.Add("@Bairro", SqlDbType.VarChar).Value = txtBairro.Text;
            comando.Parameters.Add("@Numero", SqlDbType.VarChar).Value = txtNumero.Text;
            comando.Parameters.Add("@RG", SqlDbType.VarChar).Value = mskRG.Text;
            comando.Parameters.Add("@CPF", SqlDbType.VarChar).Value = mskCPF.Text.Replace(",", "").Replace("-", "").Trim();
            comando.Parameters.Add("@Complemento", SqlDbType.VarChar).Value = txtComplemento.Text;
            comando.Parameters.Add("@StatusFunc", SqlDbType.VarChar).Value = cboStatus.Text;
        ...
        private void btnApagar_Click(object sender, EventArgs e)
        {
            ...
            strSql = "update funcionario set StatusFunc = 'inativo' where CPF=@CPF";
            ...
            {
                MessageBox.Show("DIGITE UM CPF DE UM FUNCIONÁRIO CADASTRADO!", "ERRO!", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else
            {
                try
        ...
        private void addfuncionario_KeyDown(object sender, KeyEventArgs e)
        {
